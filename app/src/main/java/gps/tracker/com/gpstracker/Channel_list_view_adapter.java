...
class Channel_list_view_adapter extends BaseAdapter {
    ...
    public Channel_list_view_adapter(Context context, ArrayList<Channel_list> results) {
        channellist = results;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final Channel_list_view_adapter.ViewHolder holder;
        if (convertView == null) {
            ...
            holder = (Channel_list_view_adapter.ViewHolder) convertView.getTag();
