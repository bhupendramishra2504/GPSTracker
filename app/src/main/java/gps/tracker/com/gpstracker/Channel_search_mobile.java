...
class Channel_search_mobile extends BaseAdapter {
    ...
    public Channel_search_mobile(Context context, ArrayList<Channel_search> results) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final Channel_search_mobile.ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.channel_search_list_view, parent, false);
            holder = new Channel_search_mobile.ViewHolder();
            ...
            holder = (Channel_search_mobile.ViewHolder) convertView.getTag();
        }
