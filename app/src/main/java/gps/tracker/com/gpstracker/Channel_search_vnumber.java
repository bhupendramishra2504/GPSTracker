...
class Channel_search_vnumber extends BaseAdapter {
    ...
    public Channel_search_vnumber(Context context, ArrayList<Channel_search> results) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        final Channel_search_vnumber.ViewHolder holder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.channel_search_list_view, parent, false);
            holder = new Channel_search_vnumber.ViewHolder();
            ...
            holder = (Channel_search_vnumber.ViewHolder) convertView.getTag();
        }
